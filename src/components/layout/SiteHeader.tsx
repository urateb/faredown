  ...
  return (
    <header
      className={cn(
        ...
        floating
          ? 'bg-ink-950/40 backdrop-blur-xl'
          : 'border-ink-800/80 border-b bg-ink-950/85 backdrop-blur-xl',
      )}
    >
      ...
      <nav className="flex items-center gap-1 sm:gap-2" aria-label="Primary">
        <Link
          href="/about"
          className="text-ink-300 hover:text-ink-50 rounded-lg px-2.5 py-1.5 text-sm font-medium transition-colors"
        >
          How it works
        </Link>
        <a
          ...
          className="text-ink-300 hover:text-ink-50 inline-flex items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-sm font-medium transition-colors"
        >
